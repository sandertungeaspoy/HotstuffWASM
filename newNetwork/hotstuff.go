...
type Signature interface {
	...
	// NewSignature(r big.Int, s big.Int, signer ID) *Signature
}
...
type QuorumCert interface {
	...
	BlockHash() Hash
	// GetSignatures returns the signatures stored
	// GetSignatures() map[ID]*ecdsa.Signature
	// GetStringSignatures() returns the map of signatures as a string
	GetStringSignatures() string
}
